import { headingsPlugin, linkPlugin, listsPlugin, markdownShortcutPlugin, MDXEditor, quotePlugin } from "@mdxeditor/editor"
...
export const MarkdownEditor = () => {
    ...
    return (
        <MDXEditor
            ...
            plugins={[markdownShortcutPlugin(), headingsPlugin(), listsPlugin(), linkPlugin(), quotePlugin()]}
